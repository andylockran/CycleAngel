...
@register.inclusion_tag('cycleangel/tags/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag(
    'cycleangel/tags/standard_index_listing.html',
    takes_context=True
)
...
@register.inclusion_tag('cycleangel/tags/breadcrumbs.html', takes_context=True)
